...
export default class Enemy {
  ...
  takeDamage(tear) {
    ...
    this.sprite.body.setVelocity(
      -tearDirectionX * (tear.knockback - this.knockbackResistance),
      -tearDirectionY * (tear.knockback - this.knockbackResistance)
    );
  ...
  handlePlayerCollision(enemy, player) {
    ...
    if (currentTime - this.lastCollisionTime > 500) {
      ...
      enemy.body.setVelocity(
        overlapX * knockbackForce,
        overlapY * knockbackForce
      );
