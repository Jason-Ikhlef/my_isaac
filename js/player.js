export default class Player {
    constructor(scene) {
        ...
        this.player = scene.add.container(window.innerWidth / 2, window.innerHeight / 2, [this.head, this.body]);
    ...
    initHearts() {
        ...
        for (let i = 0; i < this.maxHearts; i++) {
            let heart = this.scene.add.image(startX + i * heartSpacing, startY, 'hearts').setFrame(0);
    ...
    update() {
        ...
        } else if (this.cursors.down.isUp || this.cursors.right.isUp || this.cursors.up.isUp || this.cursors.left.isUp) {
