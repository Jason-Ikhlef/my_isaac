export default class TitleScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.atlas('fly', 'assets/ui/titlescreen/fly.png', 'assets/animations/fly.json');
        this.load.atlas('start', 'assets/ui/titlescreen/start.png', 'assets/animations/start.json');
    ...
    create() {
        ...
        let main = this.add.image(this.cameras.main.width / 2, this.cameras.main.height / 2, 'main');
